...
class BaseController {
 ...
 async get(req, res) {
  try {
    let filter = {};
    let { select, populate, query: qfields, params, pre, post, sort, searchFields } = this.config.get;
    ...
    // Regex search based on config.searchFields
    if (req.query.search && searchFields && searchFields.length) {
